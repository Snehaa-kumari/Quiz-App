...
const showQuizResult = () => {
  ...
  const resultText = `You answered <b>${correctedAnswercount}</b> out of <b>${numberOfQuestions}</b> questions correctly. Great effort!`;
...
const startTimer = () => {
  timer = setInterval(() => {
    ...
    //Display all answwer after options after one option is selected 
...
const handleAnswer = (option, answerIndex) => {
    ...
    !isCorrect ? highlightCorrectAnswer () : correctedAnswercount++;
